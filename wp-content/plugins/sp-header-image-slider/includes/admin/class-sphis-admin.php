...
class Sphis_Admin {
	...
	function __construct() {
		...
		add_action( 'admin_menu', array($this, 'sphis_register_menu') );
	 ...
	 * @since 1.1
	 */
	function sphis_register_menu() {
		add_submenu_page ( 'edit.php?post_type='.SPHIS_POST_TYPE, __('Shortcode Design', 'wmpci'), __('Shortcode Design', 'wmpci'), 'manage_options', 'sphis-designs', array($this, 'sphis_design_page') );
	}

	function sphis_design_page(){
		include_once( SPHIS_DIR . '/includes/admin/designs/sphis-designs.php' );
	}
